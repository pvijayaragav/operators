...
var log = logf.Log.WithName("controller_vrouterdaemonset")
...
func newReconciler(mgr manager.Manager) reconcile.Reconciler {
	return &ReconcileVrouterDaemonSet{client: mgr.GetClient(), scheme: mgr.GetScheme()}
}

func add(mgr manager.Manager, r reconcile.Reconciler) error {
	c, err := controller.New("vrouterdaemonset-controller", mgr, controller.Options{Reconciler: r})
	if err != nil {
		return err
	}

	err = c.Watch(&source.Kind{Type: &contrailoperatorsv1alpha1.VrouterDaemonSet{}}, &handler.EnqueueRequestForObject{})
	if err != nil {
		return err
	}
	...
	err = c.Watch(&source.Kind{Type: &corev1.Pod{}}, &handler.EnqueueRequestForOwner{
		IsController: true,
		OwnerType:    &contrailoperatorsv1alpha1.VrouterDaemonSet{},
	})
	if err != nil {
		return err
	}
...
var _ reconcile.Reconciler = &ReconcileVrouterDaemonSet{}

type ReconcileVrouterDaemonSet struct {
	client client.Client
	scheme *runtime.Scheme
}

func (r *ReconcileVrouterDaemonSet) Reconcile(request reconcile.Request) (reconcile.Result, error) {
	reqLogger := log.WithValues("Request.Namespace", request.Namespace, "Request.Name", request.Name)
	reqLogger.Info("Reconciling VrouterDaemonSet")
	instance := &contrailoperatorsv1alpha1.VrouterDaemonSet{}
...
func newNodeMgrCmForDS(cr *contrailoperatorsv1alpha1.VrouterDaemonSet) *corev1.ConfigMap{
...
func newAgentCmForDS(cr *contrailoperatorsv1alpha1.VrouterDaemonSet) *corev1.ConfigMap{
...
func initContainersForDS(cr *contrailoperatorsv1alpha1.VrouterDaemonSet) []corev1.Container{
...
func containersForDS(cr *contrailoperatorsv1alpha1.VrouterDaemonSet) []corev1.Container{
	return []corev1.Container{
		{
...
func newDSForCR(cr *contrailoperatorsv1alpha1.VrouterDaemonSet) *appsv1.DaemonSet{
