...
var log = logf.Log.WithName("controller_configdbdaemonset")
...
// Add creates a new ConfigDbDaemonSet Controller and adds it to the Manager. The Manager will set fields on the Controller
...
func newReconciler(mgr manager.Manager) reconcile.Reconciler {
	return &ReconcileConfigDbDaemonSet{client: mgr.GetClient(), scheme: mgr.GetScheme()}
}

// add adds a new Controller to mgr with r as the reconcile.Reconciler
func add(mgr manager.Manager, r reconcile.Reconciler) error {
	// Create a new controller
	c, err := controller.New("configdbdaemonset-controller", mgr, controller.Options{Reconciler: r})
	if err != nil {
		return err
	}

	// Watch for changes to primary resource ConfigDbDaemonSet
	err = c.Watch(&source.Kind{Type: &contrailoperatorsv1alpha1.ConfigDbDaemonSet{}}, &handler.EnqueueRequestForObject{})
	if err != nil {
		return err
	}

	// TODO(user): Modify this to be the types you create that are owned by the primary resource
	// Watch for changes to secondary resource Pods and requeue the owner ConfigDbDaemonSet
	err = c.Watch(&source.Kind{Type: &corev1.Pod{}}, &handler.EnqueueRequestForOwner{
		IsController: true,
		OwnerType:    &contrailoperatorsv1alpha1.ConfigDbDaemonSet{},
	})
	if err != nil {
		return err
	}
...
var _ reconcile.Reconciler = &ReconcileConfigDbDaemonSet{}

// ReconcileConfigDbDaemonSet reconciles a ConfigDbDaemonSet object
type ReconcileConfigDbDaemonSet struct {
...
func (r *ReconcileConfigDbDaemonSet) Reconcile(request reconcile.Request) (reconcile.Result, error) {
	reqLogger := log.WithValues("Request.Namespace", request.Namespace, "Request.Name", request.Name)
	reqLogger.Info("Reconciling ConfigDbDaemonSet")
	instance := &contrailoperatorsv1alpha1.ConfigDbDaemonSet{}
...
func newNodeMgrCmForDS(cr *contrailoperatorsv1alpha1.ConfigDbDaemonSet) *corev1.ConfigMap{
...
func newAgentCmForDS(cr *contrailoperatorsv1alpha1.ConfigDbDaemonSet) *corev1.ConfigMap{
...
func initContainersForDS(cr *contrailoperatorsv1alpha1.ConfigDbDaemonSet) []corev1.Container{
...
func containersForDS(cr *contrailoperatorsv1alpha1.ConfigDbDaemonSet) []corev1.Container{
	return []corev1.Container{
		{
...
func newDSForCR(cr *contrailoperatorsv1alpha1.ConfigDbDaemonSet) *appsv1.DaemonSet{
