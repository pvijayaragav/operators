package controllerconfigdaemonset
...
var log = logf.Log.WithName("controller_controllerconfigdaemonset")
...
// Add creates a new ControllerConfigDaemonSet Controller and adds it to the Manager. The Manager will set fields on the Controller
...
func newReconciler(mgr manager.Manager) reconcile.Reconciler {
	return &ReconcileControllerConfigDaemonSet{client: mgr.GetClient(), scheme: mgr.GetScheme()}
}

// add adds a new Controller to mgr with r as the reconcile.Reconciler
func add(mgr manager.Manager, r reconcile.Reconciler) error {
	// Create a new controller
	c, err := controller.New("controllerconfigdaemonset-controller", mgr, controller.Options{Reconciler: r})
	if err != nil {
		return err
	}

	// Watch for changes to primary resource ControllerConfigDaemonSet
	err = c.Watch(&source.Kind{Type: &contrailoperatorsv1alpha1.ControllerConfigDaemonSet{}}, &handler.EnqueueRequestForObject{})
	if err != nil {
		return err
	}

	// TODO(user): Modify this to be the types you create that are owned by the primary resource
	// Watch for changes to secondary resource Pods and requeue the owner ControllerConfigDaemonSet
	err = c.Watch(&source.Kind{Type: &corev1.Pod{}}, &handler.EnqueueRequestForOwner{
		IsController: true,
		OwnerType:    &contrailoperatorsv1alpha1.ControllerConfigDaemonSet{},
	})
	if err != nil {
		return err
	}
...
var _ reconcile.Reconciler = &ReconcileControllerConfigDaemonSet{}

// ReconcileControllerConfigDaemonSet reconciles a ControllerConfigDaemonSet object
type ReconcileControllerConfigDaemonSet struct {
...
// Reconcile reads that state of the cluster for a ControllerConfigDaemonSet object and makes changes based on the state read
// and what is in the ControllerConfigDaemonSet.Spec
// TODO(user): Modify this Reconcile function to implement your Controller logic.  This example creates
// a Pod as an example
// Note:
// The Controller will requeue the Request to be processed again if the returned error is non-nil or
// Result.Requeue is true, otherwise upon completion it will remove the work from the queue.
func (r *ReconcileControllerConfigDaemonSet) Reconcile(request reconcile.Request) (reconcile.Result, error) {
	reqLogger := log.WithValues("Request.Namespace", request.Namespace, "Request.Name", request.Name)
	reqLogger.Info("Reconciling ControllerConfigDaemonSet")

	// Fetch the ControllerConfigDaemonSet instance
	instance := &contrailoperatorsv1alpha1.ControllerConfigDaemonSet{}
	...
	// Set ControllerConfigDaemonSet instance as the owner and controller
...
func newNodeMgrCmForDS(cr *contrailoperatorsv1alpha1.ControllerConfigDaemonSet) *corev1.ConfigMap{
...
func newAgentCmForDS(cr *contrailoperatorsv1alpha1.ControllerConfigDaemonSet) *corev1.ConfigMap{
...
func initContainersForDS(cr *contrailoperatorsv1alpha1.ControllerConfigDaemonSet) []corev1.Container{
...
func containersForDS(cr *contrailoperatorsv1alpha1.ControllerConfigDaemonSet) []corev1.Container{
	return []corev1.Container{
		{
...
func newDSForCR(cr *contrailoperatorsv1alpha1.ControllerConfigDaemonSet) *appsv1.DaemonSet{
