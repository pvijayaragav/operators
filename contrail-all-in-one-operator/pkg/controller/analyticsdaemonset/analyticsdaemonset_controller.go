...
var log = logf.Log.WithName("controller_analyticsdaemonset")
...
// Add creates a new AnalyticsDaemonSet Controller and adds it to the Manager. The Manager will set fields on the Controller
...
func newReconciler(mgr manager.Manager) reconcile.Reconciler {
	return &ReconcileAnalyticsDaemonSet{client: mgr.GetClient(), scheme: mgr.GetScheme()}
}

// add adds a new Controller to mgr with r as the reconcile.Reconciler
func add(mgr manager.Manager, r reconcile.Reconciler) error {
	// Create a new controller
	c, err := controller.New("analyticsdaemonset-controller", mgr, controller.Options{Reconciler: r})
	if err != nil {
		return err
	}

	// Watch for changes to primary resource AnalyticsDaemonSet
	err = c.Watch(&source.Kind{Type: &contrailoperatorsv1alpha1.AnalyticsDaemonSet{}}, &handler.EnqueueRequestForObject{})
	if err != nil {
		return err
	}

	// TODO(user): Modify this to be the types you create that are owned by the primary resource
	// Watch for changes to secondary resource Pods and requeue the owner AnalyticsDaemonSet
	err = c.Watch(&source.Kind{Type: &corev1.Pod{}}, &handler.EnqueueRequestForOwner{
		IsController: true,
		OwnerType:    &contrailoperatorsv1alpha1.AnalyticsDaemonSet{},
	})
	if err != nil {
		return err
	}
...
var _ reconcile.Reconciler = &ReconcileAnalyticsDaemonSet{}

// ReconcileAnalyticsDaemonSet reconciles a AnalyticsDaemonSet object
type ReconcileAnalyticsDaemonSet struct {
...
func (r *ReconcileAnalyticsDaemonSet) Reconcile(request reconcile.Request) (reconcile.Result, error) {
	reqLogger := log.WithValues("Request.Namespace", request.Namespace, "Request.Name", request.Name)
	reqLogger.Info("Reconciling AnalyticsDaemonSet")
	instance := &contrailoperatorsv1alpha1.AnalyticsDaemonSet{}
...
func newNodeMgrCmForDS(cr *contrailoperatorsv1alpha1.AnalyticsDaemonSet) *corev1.ConfigMap{
...
func newAgentCmForDS(cr *contrailoperatorsv1alpha1.AnalyticsDaemonSet) *corev1.ConfigMap{
...
func initContainersForDS(cr *contrailoperatorsv1alpha1.AnalyticsDaemonSet) []corev1.Container{
...
func containersForDS(cr *contrailoperatorsv1alpha1.AnalyticsDaemonSet) []corev1.Container{
	return []corev1.Container{
		{
...
func newDSForCR(cr *contrailoperatorsv1alpha1.AnalyticsDaemonSet) *appsv1.DaemonSet{
